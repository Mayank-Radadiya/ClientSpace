...
## Corpus Check
- 517 files · ~271,711 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3300 nodes · 6373 edges · 230 communities (212 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b4f83ad2`
...
6. `getSessionContext()` - 33 edges
7. `createTRPCContext` - 32 edges
8. `clients` - 32 edges
9. `ClientSpace` - 32 edges
10. `createClient()` - 25 edges
...
- `SignContractPage()` --calls--> `NotFound()`  [INFERRED]
  src/app/(public)/sign/[token]/page.tsx → src/app/not-found.tsx

## Communities (230 total, 18 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (54): DeleteFileDialog(), DeleteFileDialogProps, CurrencyTooltip(), formatMoney(), formatCents(), StatsCards(), UploadDropzone(), UploadDropzoneProps (+46 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (56): AcceptInvitePage(), metadata, PageProps, ClientAuthPage(), metadata, PageProps, AcceptInviteSignInInput, acceptInviteSignInSchema (+48 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (41): AddClientPage(), metadata, getActiveOrgId(), getSessionContext(), COOKIE_OPTIONS, GET(), ClientLayout(), ClientHeader() (+33 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (31): ArchiveDialog(), DeleteDialog(), InsightWidgetsProps, MetricCardsProps, ProjectSidebar(), ProjectSidebarProps, ProjectPermissions, Invoice (+23 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (35): getCachedUser(), mockGetUser, mockUser, invalidateUserCache(), clearActiveOrg(), LoginFormType, loginSchema, ResendOtpInput (+27 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (29): globalForDb, comments, folders, milestones, projectNotes, filesRouter, invoicesRouter, projectNotesRouter (+21 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (30): ContractPDF(), ContractPDFProps, s, signContractAction(), SignContractInput, ContractSendRequestedEvent, ContractSignedEvent, processSignedContract (+22 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (33): ClientsFilterBarProps, SORT_OPTIONS, Client, DEFAULT_ITEM, InvoiceBuilder(), InvoiceBuilderProps, Project, useDescriptionHistory() (+25 more)
...
Cohesion: 0.06
Nodes (18): SidebarUser, SidebarUserProps, SidebarUserContainer, CompositeTypes, Database, Enums, Json, PublicSchema (+10 more)
...
Cohesion: 0.08
Nodes (32): clientIdSchema, updateClientSchema, updateLifecycleSchema, RecentActivityFeed(), RevenueChart(), DashboardPage(), metadata, activityLogs (+24 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (20): BillingContent(), metadata, BillingStatusCard(), BillingStatusCardProps, StatusBadge(), ConnectStripeCard(), QUERY_INPUT, GetNotificationsOutput (+12 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (35): baseStyles, InvoicePDFProps, Client, InvoicePreview(), InvoicePreviewProps, InvoicePreviewPanel(), InvoicePreviewPanelProps, canTransition() (+27 more)

### Community 15 - "Community 15"
Cohesion: 0.11
Nodes (26): clients, projectMembers, projectPriorityEnum, projectStatusEnum, metadata, ProjectsPage(), updateProjectSchema, projectColumns (+18 more)

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (29): ClientDetailPage(), MetricBlock(), Tab, TABS, AlertSeverity, ClientHealthAlert, ClientHealthBanner(), ClientHealthBannerProps (+21 more)
...
Cohesion: 0.08
Nodes (17): ErrorPage(), ErrorPageProps, ClientSignInTabProps, ClientSignUpTabProps, CommentInputProps, containerVariants, CreateOrganizationForm(), initialState (+9 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (31): ProjectInput, baseProjectSchema, CreateMilestoneInput, createMilestoneSchema, listMilestonesSchema, milestoneIdSchema, MilestonePriority, milestonePrioritySchema (+23 more)

### Community 21 - "Community 21"
Cohesion: 0.09
Nodes (26): CreateInvoiceDialog(), InvoiceBulkActionBar(), InvoiceData, InvoiceList(), InvoiceListProps, tableLayoutClass(), Client, InvoicesPageClient() (+18 more)

### Community 22 - "Community 22"
Cohesion: 0.12
Nodes (17): NewContractModalProps, PasswordField, PasswordFieldProps, SigningPageClientProps, TabMode, UpdatePasswordForm(), ForgotPasswordForm(), metadata (+9 more)

### Community 23 - "Community 23"
Cohesion: 0.08
Nodes (20): useReducedMotion(), ProjectMember, ChatPanel(), ChatPanelProps, THREADS, CommandAction, CommandPalette(), CommandPaletteProps (+12 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (20): BulkActionBar(), BulkActionBarProps, Chip(), ChipProps, StatsStripProps, VelocitySparkline(), VelocitySparklineProps, formatAmount() (+12 more)

### Community 25 - "Community 25"
Cohesion: 0.09
Nodes (21): useProjectDetail(), useProjectPermissions(), ProjectDetailPage(), ProjectDetailPageProps, ActiveSection, OrgRole, AddMilestoneDialog(), TeamPopover() (+13 more)

### Community 26 - "Community 26"
Cohesion: 0.08
Nodes (17): AssetApprovalCard(), AssetApprovalCardProps, ClientApprovalCentreProps, getMimeIcon(), MIME_ICON_MAP, AssetCardProps, AssetStatus, PortalAssetList() (+9 more)

### Community 27 - "Community 27"
Cohesion: 0.11
Nodes (22): FilesTabProps, FilesToolbar(), FilesToolbarProps, sortOptions, InvoiceToolbarProps, InvoiceUiStatus, FILTER_TABS, FilterTab (+14 more)

### Community 28 - "Community 28"
Cohesion: 0.13
Nodes (20): ClientDisplayStatus, CUBIC_BEZIER, STATUS_DOT, STATUS_STYLES, AnimatedCounter(), ClientSheetTab, DetailSheetProps, ClientsGrid() (+12 more)
...
Cohesion: 0.09
Nodes (21): CLIENT_DISPLAY_STATUSES, CLIENT_SORT_OPTIONS, ClientActivityItem, ClientBootstrapStats, ClientInvoiceItem, ClientListItem, ClientProjectItem, ClientSortOption (+13 more)
...
Cohesion: 0.14
Nodes (19): FileCardProps, FileRowProps, badgeConfig, FileTypeBadge(), FileTypeBadgeProps, FileTypeIcon(), FileTypeIconProps, RecentUploadsSectionProps (+11 more)
...
Cohesion: 0.11
Nodes (14): ActivityFeedCardProps, ActivityItem, ActivityRow, ActivityTimelineProps, DiscussionsTabProps, MilestoneCard, MilestoneCardProps, Avatar() (+6 more)

### Community 35 - "Community 35"
Cohesion: 0.13
Nodes (18): ArchiveDialogProps, Client, CreateInvoiceDialogProps, Project, DeleteDialogProps, DeleteProjectDialogProps, Client, CreateProjectDialogProps (+10 more)
...
Cohesion: 0.14
Nodes (20): PRIORITY_LABELS, PriorityBadge(), PriorityBadgeProps, ANTIGRAVITY, PRIORITY_CONFIG, PriorityVisual, ProjectPriority, ProjectStatus (+12 more)

### Community 38 - "Community 38"
Cohesion: 0.14
Nodes (17): CreateCommentInput, createCommentSchema, deleteCommentSchema, EditCommentInput, editCommentSchema, assets, dispatchNotification(), NotificationEventData (+9 more)
...
Cohesion: 0.09
Nodes (16): `clients`, code:ts (export const invoiceLineItems = pgTable("invoice_line_items"), code:ts (// ─── Phase 2 Stubs ───────────────────────────────────────), code:ts (export const organizations = pgTable("organizations", {), code:ts (export const clients = pgTable("clients", {), `comments`, `folders`, `invoice_line_items` (+8 more)
...
Cohesion: 0.09
Nodes (21): activityLogsRelations, assetsRelations, clientsRelations, commentsRelations, contractsRelations, csatResponsesRelations, fileVersionsRelations, foldersRelations (+13 more)

### Community 43 - "Community 43"
Cohesion: 0.12
Nodes (19): EmptyProjects(), EmptyProjectsProps, Client, ProjectData, ProjectList(), ProjectListProps, FilterState, generateProgressBar() (+11 more)
...
Cohesion: 0.16
Nodes (16): AddClientForm(), containerVariants, initialState, itemVariants, CreateOrgInput, createOrgSchema, OnboardClientInput, onboardClientSchema (+8 more)
...
Cohesion: 0.15
Nodes (17): buildStatusCounts(), buildTypeCounts(), FilesSidebar(), FilesSidebarProps, FilterPanel(), FilterPanelProps, typeFilters, StatusFilterPanel() (+9 more)
...
Cohesion: 0.18
Nodes (12): SigningPageClient(), createDrizzleClient(), InvoicesPage(), createInvoiceSchema, createInvoiceInDb(), deleteInvoicesInDb(), updateInvoicePdfStatus(), getInvoiceDetail() (+4 more)
...
Cohesion: 0.14
Nodes (11): ActivityFeed(), ActivityFeedProps, EVENT_LABELS, ClientInvoiceList(), ClientInvoiceListProps, WhatHappensNextBanner(), WhatHappensNextBannerProps, metadata (+3 more)

### Community 56 - "Community 56"
Cohesion: 0.2
Nodes (10): AssetPage(), getUser, requireOrg(), TimeoutError, withTimeout(), DashboardLayout(), ClientDetailRoute(), metadata (+2 more)
...
Cohesion: 0.16
Nodes (15): MilestoneCommandPanel(), MilestoneStatus, useMilestones(), revalidateMilestones(), COLUMNS, KanbanBoard(), KanbanBoardProps, KanbanCard() (+7 more)
...
Cohesion: 0.16
Nodes (11): NotFound(), NotificationHistoryList(), ContractDetailPage(), FilesPage(), PortalProjectDetailPage(), ProjectDetailPageProps, ProjectInvoicesPage(), metadata (+3 more)
...
Cohesion: 0.21
Nodes (15): DEADLINE_ICONS, PROJECT_CARD_COPY, PROJECT_CARD_CURRENCY, PROJECT_CARD_FORMATS, cleanName(), DeadlineInfo, formatBudget(), getClientAvatarColor() (+7 more)
...
Cohesion: 0.16
Nodes (12): CommentInput(), CommentItem(), CommentItemProps, CommentView, initials(), Role, CommentThread(), CommentThreadProps (+4 more)
...
Cohesion: 0.16
Nodes (7): ActivityTimeline(), DashboardPageClientProps, MetricsSection(), MetricsSectionProps, Project, RecentProjectsCard(), RecentProjectsCardProps
...
Cohesion: 0.29
Nodes (8): ClientProjectCard(), ClientProjectCardProps, getStatusBadgeVariant(), Milestone, statusLabel(), Badge(), BadgeProps, badgeVariants
...
Cohesion: 0.22
Nodes (3): useCountUp(), HeroStatsBand(), HeroStatsBandProps

### Community 113 - "Community 113"
Cohesion: 0.27
Nodes (7): setActiveOrg(), switchOrgAction(), Organization, OrgDropdownProps, Organization, OrgSwitcherGrid(), OrgSwitcherGridProps
...
Cohesion: 0.22
Nodes (6): OrgRole, APPROVAL_CONFIG, FileItem, FilesTab(), FilesTabProps, MIME_PREVIEW_GRADIENT
...
## Knowledge Gaps
- **1371 isolated node(s):** `config`, `eslintConfig`, `nextConfig`, `config`, `viewport` (+1366 more)
...
- **Why does `cn()` connect `Community 0` to `Community 2`, `Community 4`, `Community 7`, `Community 137`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 152`, `Community 24`, `Community 26`, `Community 27`, `Community 28`, `Community 153`, `Community 30`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 37`, `Community 43`, `Community 44`, `Community 48`, `Community 49`, `Community 51`, `Community 54`, `Community 55`, `Community 58`, `Community 59`, `Community 62`, `Community 73`, `Community 77`, `Community 78`, `Community 79`, `Community 83`, `Community 85`, `Community 98`, `Community 103`, `Community 104`, `Community 106`, `Community 110`, `Community 111`, `Community 113`, `Community 122`, `Community 123`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 19` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 13`, `Community 18`, `Community 21`, `Community 22`, `Community 23`, `Community 150`, `Community 26`, `Community 27`, `Community 31`, `Community 32`, `Community 34`, `Community 35`, `Community 41`, `Community 43`, `Community 44`, `Community 45`, `Community 48`, `Community 49`, `Community 72`, `Community 73`, `Community 83`, `Community 106`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `trpc` connect `Community 13` to `Community 0`, `Community 7`, `Community 9`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 21`, `Community 22`, `Community 151`, `Community 24`, `Community 25`, `Community 26`, `Community 152`, `Community 28`, `Community 30`, `Community 33`, `Community 35`, `Community 170`, `Community 43`, `Community 44`, `Community 58`, `Community 65`, `Community 71`, `Community 72`, `Community 78`, `Community 79`, `Community 82`, `Community 83`, `Community 104`, `Community 122`, `Community 124`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
