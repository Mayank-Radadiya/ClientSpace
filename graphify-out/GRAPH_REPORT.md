...
## Corpus Check
- 534 files · ~284,149 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3378 nodes · 6581 edges · 239 communities (220 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `656f997e`
...
3. `Button()` - 71 edges
4. `trpc` - 59 edges
5. `createDrizzleClient()` - 36 edges
6. `createTRPCContext` - 34 edges
7. `clients` - 34 edges
8. `getSessionContext()` - 33 edges
9. `ClientSpace` - 32 edges
10. `projects` - 27 edges
...
Cohesion: 0.07
Nodes (36): ActiveProject, GeminiRiskAssessment, projectHealthNightlyAnalysis, GeminiRiskAssessment, HealthRequestedEvent, singleProjectHealthAnalysis, ContractPDF(), ContractPDFProps (+28 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (37): PlanTier, assets, fileVersions, folders, projectNotes, ActionState, ALLOWED_MIME_TYPES, CreateFileVersionInput (+29 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (38): ActivityRow, ActivityTimelineProps, CommentItem(), CommentItemProps, initials(), Role, DiscussionsTab(), DiscussionsTabProps (+30 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (41): getActiveOrgId(), getSessionContext(), GET(), CreateCommentInput, createCommentSchema, deleteCommentSchema, EditCommentInput, editCommentSchema (+33 more)
...
Cohesion: 0.09
Nodes (35): DashboardPage(), metadata, createDrizzleClient(), clients, projectMembers, projectPriorityEnum, projects, projectStatusEnum (+27 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (39): ClientProjectCard(), ClientProjectCardProps, getStatusBadgeVariant(), Milestone, statusLabel(), DeleteFileDialog(), DeleteFileDialogProps, ThemeToggle() (+31 more)
...
Cohesion: 0.08
Nodes (25): InsightWidgetsProps, MetricCardsProps, ProjectSidebar(), ProjectPermissions, Invoice, Project, formatClientName(), formatCurrency() (+17 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (23): ActivityFeedCardProps, ActivityItem, ActivityTimeline(), DashboardPageClientProps, MetricsSection(), MetricsSectionProps, RecentActivityFeed(), Project (+15 more)
...
Cohesion: 0.05
Nodes (39): button, buttonContainer, ClientInviteEmail(), ClientInviteEmailProps, container, content, divider, footer (+31 more)

### Community 12 - "Community 12"
Cohesion: 0.1
Nodes (24): NotFound(), AssetPage(), AssetPageProps, getUser, requireOrg(), TimeoutError, withTimeout(), BillingContent() (+16 more)
...
Cohesion: 0.1
Nodes (20): ClientSignInTabProps, ClientSignUpTabProps, PasswordField, PasswordFieldProps, SigningPageClientProps, TabMode, UpdatePasswordForm(), Client (+12 more)

### Community 16 - "Community 16"
Cohesion: 0.08
Nodes (30): CreateInvoiceDialog(), InvoiceBulkActionBar(), CountUpCurrency(), formatCurrency(), InvoiceFinancialSummary(), InvoiceFinancialSummaryProps, useCountUp(), InvoiceData (+22 more)

### Community 17 - "Community 17"
Cohesion: 0.09
Nodes (28): clearActiveOrg(), LoginFormType, loginSchema, ResendOtpInput, resendOtpSchema, ResetPasswordInput, resetPasswordSchema, SignupInput (+20 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (21): AddClientPage(), metadata, getCachedUser(), mockGetUser, mockUser, invalidateUserCache(), COOKIE_OPTIONS, ClientLayout() (+13 more)

### Community 19 - "Community 19"
Cohesion: 0.08
Nodes (20): ErrorPage(), ErrorPageProps, AddClientForm(), containerVariants, initialState, itemVariants, containerVariants, CreateOrganizationForm() (+12 more)

### Community 20 - "Community 20"
Cohesion: 0.08
Nodes (17): useCountUp(), useReducedMotion(), CommandAction, CommandPalette(), CommandPaletteProps, MetricBand(), MetricBandProps, MilestoneBottomSheet() (+9 more)
...
Cohesion: 0.07
Nodes (29): ClientBootstrapStats, acceptInviteSignInSchema, ClientIdInput, clientIdSchema, ClientLifecycleStatus, CreateClientNoteInput, createClientNoteSchema, InviteClientInput (+21 more)
...
Cohesion: 0.08
Nodes (19): ContractDetailClient(), ContractDetailClientProps, ContractEditor(), ContractEditorProps, EditorToolbarProps, PlaceholderData, SAVE_INDICATOR, SaveState (+11 more)

### Community 25 - "Community 25"
Cohesion: 0.1
Nodes (19): CommentInputProps, Client, DEFAULT_ITEM, InvoiceBuilder(), InvoiceBuilderProps, Project, useDescriptionHistory(), QUERY_INPUT (+11 more)
...
Cohesion: 0.1
Nodes (19): ClientDetailPage(), MetricBlock(), Tab, TABS, ClientListItem, ArchiveClientModal(), ArchiveClientModalProps, computeHealthAlert() (+11 more)

### Community 28 - "Community 28"
Cohesion: 0.11
Nodes (20): FilesTab(), FilesTabProps, InvoicesTab(), GROUPS, MilestonesTab(), MilestonesTabProps, ProjectTabsProps, UseProjectDetailProps (+12 more)

### Community 29 - "Community 29"
Cohesion: 0.11
Nodes (20): ClientsPage(), metadata, BulkActionBar(), BulkActionBarProps, ClientsEmptyState(), ClientsEmptyStateProps, ClientsPageClient(), ClientsPageClientProps (+12 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (21): CLIENT_DISPLAY_STATUSES, CLIENT_SORT_OPTIONS, ClientActivityItem, ClientDisplayStatus, ClientInvoiceItem, ClientProjectItem, ClientSortOption, ClientsFilterBar() (+13 more)

### Community 31 - "Community 31"
Cohesion: 0.14
Nodes (18): ArchiveDialog(), ArchiveDialogProps, Client, CreateInvoiceDialogProps, Project, DeleteDialog(), DeleteDialogProps, DeleteProjectDialogProps (+10 more)

### Community 32 - "Community 32"
Cohesion: 0.11
Nodes (18): useProjectDetail(), useProjectPermissions(), usePresenceContext(), PresenceAvatarsConnected(), ProjectDetailPage(), ProjectDetailPageProps, ActiveSection, OrgRole (+10 more)

### Community 33 - "Community 33"
Cohesion: 0.13
Nodes (22): PRIORITY_LABELS, PriorityBadge(), PriorityBadgeProps, ANTIGRAVITY, DEADLINE_ICONS, OBSIDIAN, PRIORITY_CONFIG, PriorityVisual (+14 more)

### Community 34 - "Community 34"
Cohesion: 0.1
Nodes (20): AssetDetailView(), AssetDetailViewProps, Role, CommentThread(), FileCommentsSheet(), FileCommentsSheetProps, Role, InvoicePreviewPanel() (+12 more)
...
Cohesion: 0.15
Nodes (22): isNextControlError(), NextControlError, ProjectPage(), ProjectPageProps, cacheTag(), getCachedMembers(), getCachedMilestones(), getCachedProject() (+14 more)
...
Cohesion: 0.1
Nodes (19): FILTER_TABS, FilterState, FilterTab, pad(), PRIORITY_COLORS, ProjectsHeader(), ProjectsHeaderProps, STATUS_COLORS (+11 more)

### Community 39 - "Community 39"
Cohesion: 0.13
Nodes (19): FileCard(), FileCardProps, ApprovalBadge(), FileRow(), FileRowProps, badgeConfig, FileTypeBadge(), FileTypeBadgeProps (+11 more)
...
Cohesion: 0.17
Nodes (15): signContractAction(), SignContractInput, contracts, CreateOrgInput, createOrgSchema, OnboardClientInput, onboardClientSchema, main() (+7 more)
...
Cohesion: 0.09
Nodes (14): `activity_logs`, `assets`, `clients`, code:ts (export const invitations = pgTable("invitations", {), code:ts (export const clients = pgTable("clients", {), `file_versions`, `folders`, `invitations` (+6 more)
...
Cohesion: 0.09
Nodes (21): canTransition(), CURRENCY_SYMBOLS, DeleteInvoicesInput, deleteInvoicesSchema, INVOICE_STATUSES, InvoiceIdInput, invoiceIdSchema, InvoiceLineItemInput (+13 more)
...
Cohesion: 0.13
Nodes (10): ProjectMember, ChatPanel(), ChatPanelProps, THREADS, priorityDotColor(), priorityLabel(), ProjectRightPanel(), ProjectRightPanelProps (+2 more)
...
Cohesion: 0.14
Nodes (13): AlertSeverity, ClientHealthAlert, ClientHealthBanner(), ClientHealthBannerProps, SEVERITY_STYLES, ClientsHeader(), ClientsHeaderProps, Invoice (+5 more)

### Community 58 - "Community 58"
Cohesion: 0.15
Nodes (9): ConnectStripeCard(), GetNotificationsOutput, NotificationHistoryList(), RouterInputs, RouterOutputs, trpc, SaveState, TeamNotes() (+1 more)
...
Cohesion: 0.14
Nodes (14): AcceptInviteFormProps, containerVariants, itemVariants, ClientAuthFormProps, containerVariants, itemVariants, ClientSignInTab(), ClientSignUpTab() (+6 more)
...
Cohesion: 0.18
Nodes (11): FilesContent(), FilesPageClient(), FilesPageClientProps, useFileDelete(), UseFileDeleteOptions, useFileDownload(), useFilesFilters(), UploadQueueItem (+3 more)

### Community 64 - "Community 64"
Cohesion: 0.19
Nodes (12): EmptyState(), EmptyStateProps, FileListEmpty(), stateConfig, FilesContentProps, FilesToolbar(), FilesToolbarProps, sortOptions (+4 more)
...
Cohesion: 0.18
Nodes (13): setActiveOrg(), AcceptInviteSignInInput, AcceptInviteSignUpInput, acceptInviteSignUpSchema, inviteClientSchema, globalForDb, AcceptInviteResult, acceptInviteSignInAction() (+5 more)
...
Cohesion: 0.18
Nodes (9): db, DbType, SessionContext, TransactionScope, InvoicesPage(), createInvoiceSchema, getInvoiceDetail(), getInvoiceList() (+1 more)
...
Cohesion: 0.16
Nodes (12): OverflowDropdownProps, PresenceAvatar(), PresenceAvatarProps, PresenceAvatars(), PresenceAvatarsProps, SIZE_CONFIG, getAvatarColor(), getInitials() (+4 more)
...
Cohesion: 0.25
Nodes (10): ConnectionStatus, useProjectPresence(), UseProjectPresenceReturn, ClientPortalPresenceWidget(), ClientPortalPresenceWidgetProps, PresenceContext, PresenceContextValue, PresenceProvider() (+2 more)
...
Cohesion: 0.18
Nodes (7): Organization, WorkspaceShellProps, MainContentWrapper(), NotificationBell(), OrgDropdown(), Organization, SidebarProps
...
Cohesion: 0.18
Nodes (5): AssetCardProps, AssetStatus, PortalAssetList(), PortalAssetListProps, ProofingCanvas()
...
Cohesion: 0.25
Nodes (6): FilesViewMode, ProjectFilesPageData, ProjectFolder, RecentUpload, SortBy, TypeFilter
...
Cohesion: 0.29
Nodes (5): ClientInvoiceList(), ClientInvoiceListProps, metadata, PortalInvoicesPage(), formatCents()
...
Cohesion: 0.29
Nodes (5): CommentInput(), CommentView, CommentThreadProps, Role, ThreadedComment
...
Cohesion: 0.33
Nodes (5): ClientLifecycleSelector(), ClientLifecycleSelectorProps, LIFECYCLE_OPTIONS, LifecycleOption, ClientLifecycleStatus

### Community 170 - "Community 170"
Cohesion: 0.4
Nodes (5): InvoiceStatusButton(), InvoiceStatusButtonProps, getNextStatus(), InvoiceStatus, NEXT_STATUS_LABELS
...
Cohesion: 0.4
Nodes (3): ClientSidebarProps, Organization, CLIENT_NAV_ITEMS
...
Cohesion: 0.4
Nodes (4): baseStyles, InvoicePDFProps, Currency, InvoiceTotals
...
## Knowledge Gaps
- **1395 isolated node(s):** `config`, `eslintConfig`, `nextConfig`, `config`, `viewport` (+1390 more)
...
- **Why does `cn()` connect `Community 6` to `Community 0`, `Community 2`, `Community 9`, `Community 140`, `Community 141`, `Community 142`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 13`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 156`, `Community 29`, `Community 30`, `Community 159`, `Community 31`, `Community 33`, `Community 34`, `Community 35`, `Community 158`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 169`, `Community 172`, `Community 48`, `Community 49`, `Community 50`, `Community 180`, `Community 57`, `Community 186`, `Community 58`, `Community 60`, `Community 65`, `Community 71`, `Community 74`, `Community 77`, `Community 84`, `Community 85`, `Community 89`, `Community 90`, `Community 93`, `Community 102`, `Community 103`, `Community 107`, `Community 108`, `Community 114`, `Community 123`, `Community 124`, `Community 127`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `trpc` connect `Community 58` to `Community 9`, `Community 13`, `Community 141`, `Community 15`, `Community 16`, `Community 143`, `Community 23`, `Community 24`, `Community 25`, `Community 155`, `Community 27`, `Community 29`, `Community 157`, `Community 31`, `Community 32`, `Community 156`, `Community 34`, `Community 35`, `Community 40`, `Community 169`, `Community 172`, `Community 48`, `Community 49`, `Community 52`, `Community 57`, `Community 63`, `Community 71`, `Community 73`, `Community 75`, `Community 77`, `Community 85`, `Community 90`, `Community 107`, `Community 108`, `Community 113`, `Community 122`, `Community 124`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 19` to `Community 2`, `Community 3`, `Community 6`, `Community 8`, `Community 13`, `Community 141`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 24`, `Community 25`, `Community 28`, `Community 159`, `Community 31`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 170`, `Community 50`, `Community 55`, `Community 58`, `Community 60`, `Community 64`, `Community 71`, `Community 108`?**
