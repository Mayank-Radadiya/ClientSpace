...
## Summary
- 3076 nodes · 5867 edges · 217 communities (198 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `920e6082`
...
Cohesion: 0.07
Nodes (41): FilesTab(), FilesTabProps, InvoicesTab(), InvoicesTabProps, GROUPS, MilestonesTab(), MilestonesTabProps, ProjectTabsProps (+33 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (28): InsightWidgetsProps, MetricCardsProps, useCountUp(), ProjectPermissions, useReducedMotion(), Project, formatCurrency(), formatStatus() (+20 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (28): ErrorPage(), ErrorPageProps, AddClientForm(), containerVariants, initialState, itemVariants, containerVariants, CreateOrganizationForm() (+20 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (32): ClientLayout(), ClientHeader(), ClientHeaderProps, assets, comments, fileVersions, folders, projectNotes (+24 more)
...
Cohesion: 0.07
Nodes (39): ClientProjectCard(), ClientProjectCardProps, getStatusBadgeVariant(), Milestone, statusLabel(), DeleteFileDialog(), DeleteFileDialogProps, InvoiceBulkActionBar() (+31 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (27): ActivityFeedCardProps, ActivityItem, ActivityTimeline(), DashboardPageClientProps, MetricsSection(), MetricsSectionProps, RecentActivityFeed(), Project (+19 more)
...
Cohesion: 0.08
Nodes (31): clientIdSchema, updateClientSchema, updateLifecycleSchema, approvalStatusEnum, clientLifecycleStatusEnum, clients, clientStatusEnum, currencyEnum (+23 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (25): register(), Client, DEFAULT_ITEM, InvoiceBuilder(), InvoiceBuilderProps, Project, useDescriptionHistory(), Client (+17 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (32): ProjectInput, milestones, baseProjectSchema, CreateMilestoneInput, createMilestoneSchema, listMilestonesSchema, milestoneIdSchema, MilestonePriority (+24 more)
...
Cohesion: 0.09
Nodes (23): AddClientModal(), AddClientModalProps, ContactExtra, CURRENCIES, INDUSTRIES, PAYMENT_TERMS, BulkActionBar(), BulkActionBarProps (+15 more)

### Community 19 - "Community 19"
Cohesion: 0.12
Nodes (20): ActivityRow, ActivityTimelineProps, DiscussionsTab(), DiscussionsTabProps, MilestoneCard, MilestoneCardProps, ProjectSidebar(), ProjectSidebarProps (+12 more)

### Community 20 - "Community 20"
Cohesion: 0.08
Nodes (23): ClientDetailPage(), MetricBlock(), Tab, TABS, AlertSeverity, ClientHealthAlert, ClientHealthBanner(), ClientHealthBannerProps (+15 more)
...
Cohesion: 0.14
Nodes (19): createDrizzleClient(), projectMembers, metadata, ProjectsPage(), updateProjectSchema, createProjectAction(), deleteProjectAction(), parseDate() (+11 more)
...
Cohesion: 0.12
Nodes (19): ClientsFilterBarProps, SORT_OPTIONS, SelectButton(), SelectButtonProps, SelectItem(), SelectTrigger(), selectTriggerVariants, SelectValue() (+11 more)
...
Cohesion: 0.14
Nodes (18): InvoiceData, InvoiceListProps, InvoiceTableSkeleton(), InvoiceTableSkeletonProps, Table(), TableBody(), TableCaption(), TableCell() (+10 more)
...
Cohesion: 0.17
Nodes (18): getActiveOrgId(), getSessionContext(), CreateCommentInput, createCommentSchema, deleteCommentSchema, EditCommentInput, editCommentSchema, InvoicePDF() (+10 more)

### Community 33 - "Community 33"
Cohesion: 0.1
Nodes (15): AddClientPage(), metadata, COOKIE_OPTIONS, GET(), db, DbType, SessionContext, TransactionScope (+7 more)
...
Cohesion: 0.15
Nodes (15): FilesPageClient(), FilesPageClientProps, useFileDelete(), UseFileDeleteOptions, useFileDownload(), useFilesFilters(), UploadQueueItem, useUploadManager() (+7 more)
...
Cohesion: 0.09
Nodes (16): `assets`, code:ts (export const invitations = pgTable("invitations", {), code:ts (export const planLimits = pgTable("plan_limits", {), code:ts (// Mirrors auth.users — id MUST match Supabase Auth UID. No ), code:ts (export const organizations = pgTable("organizations", {), `comments`, `folders`, `invitations` (+8 more)
...
Cohesion: 0.18
Nodes (16): invoiceLineItems, organizations, InvoicesPage(), createInvoiceSchema, ActionState, bulkUpdateInvoiceStatus(), createInvoice(), CreateInvoiceResult (+8 more)

### Community 47 - "Community 47"
Cohesion: 0.16
Nodes (12): requireOrg(), ClientsPage(), metadata, DashboardLayout(), ClientDetailRoute(), switchOrgAction(), Organization, OrgSwitcherGrid() (+4 more)
...
Cohesion: 0.17
Nodes (14): ClientFileUploader(), ClientFileUploaderProps, PlanTier, ActionState, ALLOWED_MIME_TYPES, CreateFileVersionInput, MAX_FILE_SIZE, UploadRequest (+6 more)

### Community 50 - "Community 50"
Cohesion: 0.15
Nodes (15): EmptyState(), EmptyStateProps, FileListEmpty(), stateConfig, FilesContent(), FilesContentProps, RecentUploadsSection(), RecentUploadsSectionProps (+7 more)
...
Cohesion: 0.19
Nodes (12): NotFound(), AssetPage(), AssetPageProps, getUser, NotificationHistoryList(), FilesPage(), PortalProjectDetailPage(), ProjectDetailPageProps (+4 more)
...
Cohesion: 0.14
Nodes (8): ProjectMember, ChatPanel(), ChatPanelProps, THREADS, ProjectTopBar(), ProjectTopBarProps, statusBg(), statusColor()
...
Cohesion: 0.19
Nodes (9): FilesViewMode, ProjectFile, ProjectFilesPageData, ProjectFolder, RecentUpload, SortBy, TypeFilter, SortBy (+1 more)
...
Cohesion: 0.25
Nodes (7): Tooltip(), TooltipContent(), TooltipProvider(), TooltipTrigger(), CommandHeaderProps, PRIORITY_DOT_COLORS, STATUS_COLORS
...
Cohesion: 0.24
Nodes (7): GetNotificationsOutput, iconMap, NotificationItem(), NotificationItemProps, NotificationType, NotificationList(), QUERY_INPUT
...
- **Why does `cn()` connect `Community 6` to `Community 0`, `Community 3`, `Community 132`, `Community 5`, `Community 7`, `Community 14`, `Community 145`, `Community 18`, `Community 17`, `Community 20`, `Community 19`, `Community 23`, `Community 24`, `Community 26`, `Community 155`, `Community 28`, `Community 29`, `Community 30`, `Community 27`, `Community 34`, `Community 37`, `Community 166`, `Community 40`, `Community 41`, `Community 44`, `Community 45`, `Community 47`, `Community 48`, `Community 50`, `Community 53`, `Community 55`, `Community 59`, `Community 60`, `Community 65`, `Community 69`, `Community 77`, `Community 78`, `Community 80`, `Community 81`, `Community 83`, `Community 93`, `Community 94`, `Community 100`, `Community 105`, `Community 107`, `Community 108`, `Community 116`, `Community 117`, `Community 119`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 3` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 14`, `Community 19`, `Community 23`, `Community 24`, `Community 26`, `Community 27`, `Community 28`, `Community 30`, `Community 34`, `Community 37`, `Community 41`, `Community 48`, `Community 49`, `Community 50`, `Community 55`, `Community 65`, `Community 67`, `Community 77`, `Community 83`, `Community 100`, `Community 101`, `Community 107`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `trpc` connect `Community 36` to `Community 1`, `Community 7`, `Community 9`, `Community 14`, `Community 144`, `Community 145`, `Community 18`, `Community 17`, `Community 20`, `Community 22`, `Community 24`, `Community 26`, `Community 155`, `Community 27`, `Community 30`, `Community 40`, `Community 41`, `Community 45`, `Community 55`, `Community 58`, `Community 66`, `Community 69`, `Community 77`, `Community 78`, `Community 80`, `Community 107`, `Community 108`, `Community 118`, `Community 119`?**
