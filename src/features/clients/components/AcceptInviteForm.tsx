...
import type { InvitationWithDetails } from "../server/queries";
...
function SubmitButton({ mode }: { mode: "signup" | "signin" }) {
...
export function AcceptInviteForm({ invitation, token }: AcceptInviteFormProps) {
                ...
                <form action={signInAction} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    {signInState.fieldErrors?.password && (
                      <p className="text-destructive px-1 text-xs" role="alert">
                        {signInState.fieldErrors.password[0]}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-3 pt-2">
                    ...
                    <p className="text-muted-foreground text-center text-xs">
                      Don't have an account? Use the "Create Account" tab
                      instead.
                    </p>
                  </div>
                </form>
