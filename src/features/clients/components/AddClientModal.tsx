...
const INPUT_CLASS =
  "w-full rounded-xl border border-border bg-muted/20 px-4 py-3 text-sm  text-foreground placeholder:text-muted-foreground/60 outline-none transition-all duration-150 focus:border-primary focus:bg-primary/5 dark:focus:border-primary";
const SELECT_CLASS =
  "w-full appearance-none rounded-xl border border-border bg-muted/20 px-4 py-3 text-sm  text-foreground outline-none transition-all duration-150 focus:border-primary cursor-pointer";
const LABEL_CLASS =
  "mb-1.5 block text-[10px] font-semibold tracking-[0.18em] text-muted-foreground uppercase ";
const SECTION_TITLE_CLASS =
  "mb-4 flex items-center gap-3 text-[11px] font-bold tracking-[0.2em] text-primary uppercase ";
          ...
          >
            <div className="bg-background border-border relative max-h-[85vh] w-full max-w-[600px] overflow-hidden rounded-2xl border shadow-[0_24px_80px_rgba(0,0,0,0.6)]">
              ...
              <form onSubmit={handleSubmit}>
                <div className="max-h-[calc(85vh-140px)] space-y-8 overflow-y-auto px-6 py-5">
                  {/* Section 1: Identity */}
                  <div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <div className="relative">
                            <span className="text-muted-foreground/60 absolute top-1/2 left-3 -translate-y-1/2 text-[11px]">
                              https://
                            </span>
                            <input
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <ChevronDown className="text-muted-foreground/60 pointer-events-none absolute top-1/2 right-3 h-3.5 w-3.5 -translate-y-1/2" />
                          </div>
                        </div>
                      </div>
                        ...
                        {logoPreview ? (
                          <div className="flex items-center gap-4">
                            ...
                            <button
                              ...
                              className="text-destructive text-[11px] tracking-wide hover:underline"
                            >
                              Remove
                            </button>
                          </div>
                  ...
                  <div>
                    <button
                      ...
                      className="text-muted-foreground hover:text-foreground flex w-full items-center gap-3 text-[11px] font-bold tracking-[0.2em] uppercase transition-colors"
                    >
                      <span className="border-muted/30 flex h-5 w-5 items-center justify-center rounded-full border text-[9px]">
                        03
                      </span>
                      Additional Contacts
                        ...
                        >
                          <div className="mt-4 space-y-3">
                            ...
                            <button
                              type="button"
                              onClick={addContact}
                              className="text-primary hover:text-primary/80 flex items-center gap-2 text-[11px] tracking-wide transition-colors"
                            >
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-2">
                          {(["active", "pending"] as const).map((s) => (
                            <button
                              ...
                              onClick={() => setStatus(s)}
                              className={cn(
                                "flex-1 rounded-xl border px-4 py-2.5 text-[11px] font-semibold tracking-[0.15em] uppercase transition-all duration-150",
                                status === s
                      ...
                      <div>
                        ...
                        <div
                          className={cn(
                            INPUT_CLASS,
                            "flex min-h-[44px] flex-wrap gap-1.5 p-2",
                          )}
                        >
                          {tags.map((tag) => (
                            <span
                              key={tag}
                              className="bg-primary/10 text-primary inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-[11px]"
                            >
                              {tag}
                              <button
                                type="button"
                      ...
                      <div className="border-border bg-muted/10 flex items-center justify-between rounded-xl border px-4 py-3">
                        <div>
                          ...
                          <p className="text-muted-foreground text-[11px]">
                            Client receives a portal invite link
                          </p>
                        </div>
                        <button
                          type="button"
                ...
                <div className="border-border flex items-center justify-end gap-3 border-t px-6 py-4">
                  <button
                    type="button"
                    onClick={handleClose}
                    className="border-border text-muted-foreground hover:border-muted-foreground/30 hover:text-foreground rounded-xl border px-5 py-2.5 text-[12px] font-semibold tracking-[0.15em] uppercase transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    disabled={submitting}
                    className="bg-primary hover:bg-primary/80 inline-flex items-center gap-2 rounded-xl px-6 py-2.5 text-[12px] font-bold tracking-[0.15em] text-white uppercase transition-all disabled:opacity-60"
                  >
                    {submitting ? (
