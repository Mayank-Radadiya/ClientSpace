      ...
      <table className="w-full">
        <thead>
          <tr className="border-border bg-muted/30 border-b">
            ...
            <th className="text-muted-foreground px-4 py-3 text-left text-[9px] font-bold tracking-[0.22em] uppercase">
              Client
            </th>
            <th className="text-muted-foreground px-4 py-3 text-left text-[9px] font-bold tracking-[0.22em] uppercase">
              Status
            </th>
            <th className="text-muted-foreground px-4 py-3 text-right text-[9px] font-bold tracking-[0.22em] uppercase">
              Projects
            </th>
            <th className="text-muted-foreground px-4 py-3 text-right text-[9px] font-bold tracking-[0.22em] uppercase">
              Outstanding
            ...
            return (
              ...
              >
                ...
                <td className="px-4 py-4 text-right">
                  <span className="text-foreground text-[18px] font-(--font-metrics)">
                ...
                <td className="px-4 py-4" onClick={(e) => e.stopPropagation()}>
                  <div className="flex items-center justify-end gap-1 opacity-0 transition-opacity group-hover:opacity-100">
                    <button
                      onClick={() => router.push(`/clients/${client.id}`)}
                      className="border-primary/30 text-primary hover:bg-primary/10 rounded-lg border px-2.5 py-1.5 text-[10px] font-bold tracking-[0.15em] uppercase transition-colors"
                    >
                      View
                    </button>
                    <RowMenu
