    ...
    >
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="relative flex shrink-0 items-center gap-2">
          ...
          <button
            onClick={onEdit}
            className="flex items-center gap-1.5 rounded-xl border px-3 py-2 text-[12px] transition-all duration-200 active:scale-[0.97] border-black/10 text-gray-600 font-mono bg-black/[0.03] hover:border-[#6C63FF]/40 hover:text-[#6C63FF] hover:bg-[#6C63FF]/10 dark:border-white/10 dark:text-white/50 dark:bg-white/[0.03] dark:hover:text-white"
          >
            <Pencil size={13} />
            Edit
          </button>
          ...
          >
            <span
              className="pointer-events-none absolute inset-0 -translate-x-full skew-x-[-20deg] bg-gradient-to-r from-transparent via-white/15 to-transparent transition-transform duration-600"
          ...
          <button
            ...
            className="flex h-[36px] w-[36px] items-center justify-center rounded-xl border transition-all duration-200 active:scale-[0.97] border-black/10 text-gray-500 bg-black/[0.03] hover:text-gray-900 hover:bg-black/10 dark:border-white/10 dark:text-white/40 dark:bg-white/[0.03] dark:hover:text-white dark:hover:bg-white/10"
          >
